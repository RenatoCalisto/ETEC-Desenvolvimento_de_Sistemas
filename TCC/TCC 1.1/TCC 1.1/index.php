...
<p>As Escolas Técnicas Estaduais (ETECs) são instituições de ensinos técnico, médio e técnico integrado ao médio (ETIM), pertencentes ao Centro Estadual de Educação Tecnológica Paula Souza (CEETEPS), autarquia da Secretaria de Desenvolvimento Econômico, Ciência e Tecnologia (SDECTI) do estado de São Paulo.</p>

<h2 class="text-center">História</h2>
<p>Na década de 1960 houve reuniões entre o Conselho Educacional para a criação de instituições que atendessem à necessidade do acompanhamento profissional e expansão industrial de São Paulo. A partir de 1967, quando Roberto Costa de Abreu Sodré assumiu o governo do estado, foi que a ideia de se criarem escolas técnicas foi se tornando cada vez mais concreta. Em 6 de outubro de 1969, o Centro Paula Souza iniciou suas atividades. Atualmente são 198 escolas, que ministram cursos técnicos e de ensino médio em 150 municípios do estado. As ETEC estão entre as melhores escolas públicas do Brasil, quando comparadas com outras escolas de ensino médio.</p>

<h2 class="text-center">Unidades</h2>

<p>As Etecs estão distribuídas em 156 municípios paulistas, como o total de 212 Etecs no Estado de São Paulo.</p>

<h2 class="text-center">Extensões das Etecs</h2>

<p>O Centro Paula Souza mantém uma parceria com a Secretaria de Educação e prefeituras dos municípios paulistas para oferecer cursos técnicos em salas de aulas que não estão em uso em Escolas Estaduais e Escolas Municipais no período noturno.</p>

<h2 class="text-center">Processo Seletivo</h2>

<p>Para ingressar numa Etec, o candidato deve passar por um vestibulinho, processo seletivo aplicado para quem pretende estudar em Escolas Técnicas Estaduais. As Etecs possuem o "Sistema de Pontuação Acrescida", no qual os candidatos que se declararem afro–descendentes recebem 3% de bônus sobre a nota, e aqueles que cursaram o ensino fundamental integralmente em escola pública ganham 10%, percentuais que são cumulativos</p>

<h2 class="text-center">Etecs no Enem</h2>

<p>Tradicionalmente, os alunos de Etecs (etequianos) têm desempenho destacado no Exame Nacional do Ensino Médio (Enem). Resultados divulgados em 2011 pelo Ministério da Educação, referentes à última prova, realizada em 2009, apontam que, entre as 50 escolas públicas estaduais do Brasil com melhor pontuação, 34 são Etecs. Das 50 melhores escolas públicas paulistas, 41 são Etecs. Das 50 escolas estaduais mais bem classificadas no Estado de São Paulo, 44 são Etecs. A Etec de São Paulo (Etesp) é a melhor escola estadual paulista. No ranking nacional, é a 2ª entre as estaduais e na capital, está em 17º lugar entre públicas e privadas, à frente de colégios particulares tradicionais. Na capital, das 10 escolas públicas com melhor pontuação, 9 são Etecs. Das 89 Etecs que participaram do Enem, 11 ficaram em primeiro lugar em seus municípios, entre públicas e privadas.</p>
